...
import { IngestAdlib, UserEditingType } from '@sofie-automation/blueprints-integration'
import { MeteorCall } from '../../lib/meteorApi'
import { Rundown } from '@sofie-automation/corelib/dist/dataModel/Rundown'
import { Buckets, Parts, Rundowns, Segments } from '../../collections'
...
import {
	...
	ImportMOSItemUserOperation,
} from '@sofie-automation/shared-lib/dist/core/model/ingest'
		...
		receiveMOSItemUserOp(
			...
			doUserAction(t, e, UserAction.EXECUTE_USER_OPERATION, (e, ts) =>
				MeteorCall.userAction.executeUserChangeOperation(
					...
					rundownId,
					operationTarget,
					literal<ImportMOSItemUserOperation>({
