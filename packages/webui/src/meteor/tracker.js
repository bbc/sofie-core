...
function requireFlush() {
	if (!willFlush) {
		...
		if (typeof Meteor !== 'undefined') Meteor._setImmediate(Tracker._runFlush)
...
Tracker.flush = function (options) {
	Tracker._runFlush({ finishSynchronously: true, throwFirstError: options && options._throwFirstError })
}
